...
const SelfReportSection = () => {
  return (
    <div className="relative animate-fade-up glass-card p-6" style={{ animationDelay: '0.2s' }}>
      <div className="absolute -top-4 -left-4 w-12 h-12 rounded-full bg-[#9b87f5] flex items-center justify-center text-white font-bold text-lg shadow-lg">3</div>
      <div className="rounded-full w-12 h-12 bg-[#9b87f5]/10 flex items-center justify-center mb-4">
        <UserCircle className="h-6 w-6 text-[#9b87f5]" />
      </div>
      ...
      <Link to="/how-it-works#self-report">
        <Button className="w-full bg-[#9b87f5] hover:bg-[#9b87f5]/90">
